...
public class GameView extends View {
    ...
    public static String birdSkin = "redbird";
    ...
    private void drawBird(String  birdSkin){
        ArrayList<Bitmap>arrBms = new ArrayList<>();
        if (birdSkin == "redbird"){
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.redbird1));
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.redbird2));
        }else if (birdSkin == "bluebird"){
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.bluebird1));
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.bluebird2));

        }else if (birdSkin == "yellowbird"){
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.yellowbird1));
            arrBms.add(BitmapFactory.decodeResource(this.getResources(), R.drawable.yellowbird2));
        }
            ...
            for(int i = 0; i < sumpipe; i++){
...

                {
                    ...
                    if(score>bestscore){
                        ...
                        //Database, set new highscore
                        AppDatabase database = AppDatabase.getInstance(context);
                        database.userDao().updateHighscoreAndCoins(1, score, score);

                    }
                    GameActivity.txt_score.setText(""+score);

                    //Database, update coins
                    AppDatabase database = AppDatabase.getInstance(context);
                    database.userDao().updateCoins(1,score);
                }
